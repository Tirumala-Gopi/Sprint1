...
public class LibraryController {
	...
	public EBook createBook(String type,String title,String author,double size)
	{
		if (type=="eBook")
		{
			System.out.println("ebook");
			EBook newBook=new EBook(title,author,size);
			books.add(newBook);
			return newBook;
		}
	...
	public PrintedBook createBook(String type,String title,String author,int pages)
	{
		if(type=="printedBook")
		{
			PrintedBook newBook=new PrintedBook(title,author,pages);
			books.add(newBook);
			return newBook;
		}
		return null;
